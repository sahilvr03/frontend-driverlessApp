...
export default function Services() {
  return (
    <>
      <Head>
        <title>Our Services | Data Solutions</title>
        <meta name="description" content="Explore our range of data services including annotation, cleaning, formatting, and raw data provisioning." />
      </Head>
