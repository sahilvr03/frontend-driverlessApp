    ...
    <div className="relative min-h-screen bg-black overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-24 h-screen flex flex-col lg:flex-row items-center justify-between gap-8">
        ...
        >
          ...
          >
            <button className="cyber-button px-8 py-4 text-lg relative overflow-hidden group">
              <span className="absolute inset-0 bg-[#00ff9d] opacity-0 group-hover:opacity-10 transition-opacity duration-300" />
              <span className="cyber-text">VIEW DEMO</span>
            </button>
            <button className="hologram-button px-8 py-4 text-lg relative overflow-hidden group">
              <span className="absolute inset-0 bg-[#00ff9d] opacity-0 group-hover:opacity-10 transition-opacity duration-300" />
  ...
  <div className="relative h-full w-full overflow-hidden rounded-xl">
    ...
    >
      ...
      <style jsx global>{`
        ...
        .cyber-button {
          background: linear-gradient(145deg, #000 30%, #00190f);
